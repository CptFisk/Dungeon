...
void
Editor::uiHeader(typeWindowCovering& area, bool& open, File::typeHeaderData& header) {
            ...
            if (!mNewFile) {
                ...
                for (int y = 0; y < MAP_WIDTH; y++) {
                    for (int x = 0; x < MAP_WIDTH; x++) {
                        ...
                        editorTiles.emplace_back(new Tile(x, y, mScale, GET_FONT_TTF("8bit16"), pRenderer));
                    }
                }
            } else {
                hideElement("Header");

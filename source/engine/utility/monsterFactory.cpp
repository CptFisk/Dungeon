...
Engine::createMonsters() {
    ...
    mMonsters[Monster::Type::CAVE_CRAWLER] = new Monster::CaveCrawler(
      75, 0.2f, playerCenter, [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); });
    ...
    mMonsters[Monster::Type::SLIME_BLUE] = new Monster::Slime(
      30, 0.2f, 8.0f, playerCenter, [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); });
    ...
    mMonsters[Monster::Type::SLIME_GREEN] = new Monster::Slime(
      60, 0.25f, 7.0f, playerCenter, [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); });
    ...
    mMonsters[Monster::Type::SLIME_PURPLE] = new Monster::Slime(
      90, 0.3f, 6.5f, playerCenter, [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); });
    ...
    mMonsters[Monster::Type::SLIME_RED] = new Monster::Slime(
      120, 0.5, 5.0f, playerCenter, [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); });
    ...
    mMonsters[Monster::Type::BEAN_MAN] = new Monster::BeanMan(
      ...
      [&](const SDL_FPoint& point, const float& x, const float& y) { return movementWalls(point, x, y); }, // Function to check for walls

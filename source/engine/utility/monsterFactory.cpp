...
Engine::createMonsters() {
    ...
    mMonsters[Monster::Type::CAVE_CRAWLER] = new Monster::CaveCrawler(75, 0.2f, playerCenter);
    ...
    mMonsters[Monster::Type::SLIME_BLUE] = new Monster::Slime(30, 0.2f, 8.0f, playerCenter);
    ...
    mMonsters[Monster::Type::SLIME_GREEN] = new Monster::Slime(60, 0.25f, 7.0f, playerCenter);
    ...
    mMonsters[Monster::Type::SLIME_PURPLE] = new Monster::Slime(90, 0.3f, 6.5f, playerCenter);
    ...
    mMonsters[Monster::Type::SLIME_RED] = new Monster::Slime(120, 0.5, 5.0f, playerCenter);

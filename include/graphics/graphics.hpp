...
class Graphics {
  ...
  protected:
    ...
    void loadFontTexture(const std::string& jsonString);          // Load a font generated by a image, really basic
    void loadFontTTFTexture(const std::string& jsonString);       // Load a TTF font
  ...
  private:
    ...
    std::unordered_map<std::string, FontTTF*> mFontsTTF; // Storage for all fonts
